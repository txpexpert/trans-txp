...
const PROCEDURES: Procedure[] = [
  ...
  },
  {
    ...
    vigilance:[
      'Délai de séjour : maximum 2 ans (24 mois) à compter de l\'enregistrement de la déclaration d\'importation, sauf dérogation ministérielle ; réduit à 1 an en cas de cession de produits compensateurs si le reliquat de validité est inférieur à 12 mois (CDII art. 137 ; circ. 6164/313, Annexe I) — corrigé, le fichier indiquait à tort "36 mois"',
    ...
    normes:[
      'CDII — Articles 135 à 144 (Chapitre III — Admission temporaire pour perfectionnement actif) — corrigé, le fichier citait à tort les articles 196-218',
      'Décret n° 2-77-862 — Articles 99 à 109 (bureaux compétents, acquit à caution, apurement)',
      'Circulaires ADII relatives à l\'ATPA (notamment circ. 6164/313 du 09/02/2021)',
  ...
  },
  {
    ...
    vigilance:[
      'Délai de séjour variable selon la catégorie de matériel (décret 2-77-862, art. 132) — corrigé, le fichier indiquait à tort "12 mois en règle générale" : 2 ans pour les catégories Ca, Cc, D3, D9, D11 ; 1 an pour la catégorie Cb ; 6 mois pour la catégorie D (autres) ; durée selon conventions internationales pour la catégorie E. Prorogeable au double par le ministre ou le DG délégué',
      ...
      'Toute cession nécessite une régularisation préalable',
    ],
    vigilanceQ:[],
    procedures:[
    ...
    normes:[
      'CDII — Articles 145 à 151 bis (Chapitre IV — Admission temporaire) — corrigé, le fichier citait à tort les articles 186-195',
      'Décret n° 2-77-862 — Articles 125 à 137 (durées de séjour par catégorie, redevances trimestrielles)',
    ...
    questionsOuvertes:['Nombre maximum de prorogations au-delà du doublement prévu à l\'article 132 du décret — non précisé dans le RAG'],
  },
  {
    ...
    vigilance:[
      ...
      'Durée de séjour : 1 an maximum à compter de l\'enregistrement de la déclaration d\'entrée (CDII art. 163 quinquies ; circ. 6164/313) — pour le régime fractionné (241), la durée initiale est de 3 mois, prorogeable sans dépasser 9 mois supplémentaires (décret 2-77-862, art. 172 septies)',
    ],
    vigilanceQ:['Conditions spécifiques TSD papier d\'édition (code 242) à détailler — non trouvé dans le RAG'],
    procedures:[
  ...
  },
  {
    ...
    vigilance:[
      ...
      'Délai de séjour à l\'étranger : 1 an maximum pour les catégories C et D, prorogation possible jusqu\'au double du délai sur autorisation motivée du ministre chargé des finances (décret 2-77-862, art. 160)',
    ],
    vigilanceQ:[],
    procedures:[
  ...
  },
  {
    ...
    vigilance:[
      ...
      'Délai : 1 an (ETPP standard) ; réduit à 6 mois pour l\'ETPP avec échange standard (circ. 6164/313, Annexe I)',
    ],
    vigilanceQ:[],
    procedures:[
  ...
  },
  {
    ...
    vigilance:[
      ...
      'Délai de séjour à l\'étranger : 1 an maximum, prorogeable jusqu\'au double sur autorisation motivée (décret 2-77-862, art. 160)',
    ],
    vigilanceQ:[],
    procedures:[
  ...
  },
  {
    ...
    codes:[
      {code:'381',label:'EIF importation directe de matières premières'},
    ...
    vigilance:[
      ...
      'Réservé aux entreprises réalisant un investissement (création ou extension) d\'au moins 50 000 000 DH (CDII art. 134 bis-quater ; décret 2-77-862, art. 98 bis)',
      'Durée : 2 ans pour les marchandises destinées à être mises en œuvre par les équipements ; durée nécessaire à l\'utilisation pour les matériels et équipements eux-mêmes (circ. 6164/313, Annexe I)',
    ],
    vigilanceQ:['Le code "038" cité dans une version antérieure de cette fiche n\'apparaît pas dans la nomenclature ADII (circ. 6047/312) — probable coquille pour le code 381 (EIF importation directe de matières premières), distinct du code 385 (EIF importation directe de matériel/équipements). À confirmer avec l\'ADII si un code 038 existe réellement.'],
    procedures:[
  ...
  },
  {
    ...
    vigilance:[
      ...
      'Durée de séjour : 1 an, prorogeable deux fois six mois (maximum 24 mois) — harmonisée avec l\'entrepôt public et l\'entrepôt privé banal (circ. 5171/313 ; décret 2-77-862, art. 93-94)',
    ],
    vigilanceQ:['Fréquence des inventaires contradictoires ADII à préciser — non trouvé dans le RAG'],
    procedures:[
  ...
  },
  {
    ...
    vigilance:[
      'Durée maximum de séjour fixée par les articles 66 ou 106 du CDII, courant depuis la déclaration sommaire d\'entrée (code douanes art. 61-62) — soit, en pratique, le délai de droit commun de dépôt de la déclaration en détail de 45 jours (arrêté 1318-77, art. 2) ; corrigé, le fichier indiquait à tort "30 à 90 jours"',
      'Frais de magasinage s\'accumulent dès l\'entrée',
      'À l\'expiration du délai, les marchandises non déclarées en détail ou non enlevées sont considérées comme abandonnées en douane (art. 106 CDII) et l\'exploitant doit les mettre à disposition de l\'administration pour cession ou destruction',
  ...
  {
    id:'stockage-zfl', categorie:'STOCKAGE',
    titre:'ZFL — Zone Franche Logistique (ex. Tanger Med)',
    codes:[
      {code:'769',label:'Exportation via les zones franches logistiques (ZFL)'},
      {code:'682',label:'Exportation vers l\'étranger en suite d\'exportation via ZFL'},
    ],
    description:'Zones franches logistiques (ZFL, ex. Tanger Med) : régime distinct de la ZAI industrielle, créé par circ. 6047/312 pour les exportateurs stockant leurs marchandises en attendant leur expédition ferme vers un client final. Le code 769 couvre la livraison ferme à la ZFL (avec imputation des comptes RED des intrants) ; le code 682 couvre l\'expédition finale vers l\'étranger, avec certification d\'origine préférentielle possible dans un délai d\'un an à compter de l\'exportation vers la ZFL (circ. 5549/230).',
    vigilance:[
      'La ZFL est une zone franche à part entière (soustraite à tout ou partie des lois douanières, loi 19-94 art. 1) — contrairement à ce qu\'indiquait la version précédente de cette fiche',
      'Le certificat d\'origine préférentiel (EUR.1, EUR-MED…) peut être délivré en remplacement à la sortie de ZFL, selon la procédure de la circ. 5549/230',
      'La déclaration du fabricant (Annexe 3) et l\'état de prise en charge et de suivi de l\'origine sont exigés à l\'introduction en ZFL',
      'Le schéma antérieur (codes 765 puis 681) reste utilisé quand le client final n\'est pas connu à l\'avance ; les codes 769/682 sont réservés aux ventes fermes',
    ],
    vigilanceQ:[],
    procedures:[
      'Introduction en ZFL depuis l\'étranger : bulletin d\'entrée du gestionnaire, facture, liste de colisage, connaissement, original de la preuve d\'origine, état de prise en charge (Annexe 2)',
      'Introduction en ZFL depuis le TA (livraison ferme) : DUM code 769, imputation le cas échéant des comptes RED des intrants et emballages',
      'Introduction en ZFL depuis une zone franche industrielle : acquit à caution de transit (code 856)',
      'Expédition finale vers le client étranger : DUM code 682, avec certificat d\'origine préférentiel si éligible',
    ],
    normes:['Loi n° 19-94 relative aux zones franches d\'exportation (art. 1 et 24)','Circ. 6047/312 (codes 769/682)','Circ. 5549/230 (origine en ZFL)','Lettre du Premier Ministre n° 2008 du 27/11/2009'],
    documents:['Bulletin d\'entrée / de sortie du gestionnaire de la ZFL','Facture, liste de colisage, connaissement','Déclaration du fabricant (Annexe 3) pour les marchandises obtenues sur le TA','État de prise en charge et de suivi de l\'origine (Annexe 2)','DUM (769 ou 682 selon le sens)'],
    checklist:[
      'Régime d\'introduction identifié (provenance étranger / TA / zone franche industrielle)',
      'DUM déposée avec le code approprié (769 ou 682)',
      'État de prise en charge et de suivi de l\'origine établi',
      'Certificat d\'origine préférentiel demandé si éligible (délai d\'un an)',
      'DUM de sortie déposée',
    ],
    conseilIA:'Le code 769 remplace avantageusement le schéma ET (765) puis exportation définitive (681) dès que le client final est connu au moment de la livraison à la ZFL — il évite une double déclaration et permet l\'imputation directe des comptes RED.',
    questionsOuvertes:[],
  },
  {
  ...
  },
  {
    ...
    vigilanceQ:['CODE NON CONFIRMÉ : aucun document du RAG projet n\'attribue un code DUM dédié à ce flux hybride TA→ZAI→TA ; à valider directement avec le bureau douanier de la ZAI concernée'],
    procedures:[
