// pages/app/decisions-classement.tsx
// Copie indépendante de pages/modules/decisions-classement.tsx pour /app.
// ⚠️ Toute mise à jour de la page desktop doit être répercutée ici manuellement.
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  const redirectTo = await requireAppAccess(context, 'decisions-classement')
